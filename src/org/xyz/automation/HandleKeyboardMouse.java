...
import org.wipro.uo.automation.utilitiesClass.CaptureScreenshot;
...
public class HandleKeyboardMouse 
{
	...
	public void handleFrames() throws Exception
	{
		...
		CaptureScreenshot.saveresult(driver,"handleFrames");
	...
	public void handleAlerts() throws Exception
	{
		...
		CaptureScreenshot.saveresult(driver,"handleAlerts");
	}
